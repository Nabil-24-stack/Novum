...
export const FREE_SHARED_BUDGET_USD_MICROS = envInt("BILLING_FREE_SHARED_BUDGET_USD_MICROS", 1_500_000);

// Pro tier limits
export const PRO_MONTHLY_BUDGET_USD_MICROS = envInt("BILLING_PRO_MONTHLY_BUDGET_USD_MICROS", 10_000_000);
